model mod_LinearOne
  EFA_Blocks_simple.ETA eta1 annotation(Placement(visible = true, transformation(origin = {2.34899,15.1007}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  EFA_Blocks_simple.signalSource signalsource1 annotation(Placement(visible = true, transformation(origin = {-52.6846,13.4228}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
