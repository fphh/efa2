model BrakeSystem
  ...
  Modelica.Blocks.Math.Gain Gain(k = 100) annotation(Placement(visible = true, transformation(origin = {-27.5862,9.77011}, extent = {{-12,-12},{12,12}}, rotation = 0)));
...
equation
  connect(PedalPosition,Gain.u) annotation(Line(points = {{-72.9885,8.62069},{-43.1034,8.62069},{-43.1034,9.77011},{-41.9862,9.77011}}));
  ...
  connect(Gain.y,ShareFrontAxle.u) annotation(Line(points = {{-14.3862,9.77011},{-7.47126,9.77011},{-7.47126,50},{1.69195,50},{1.69195,50.5747}}));
  connect(feedback1.u1,Gain.y) annotation(Line(points = {{14.5379,-41.3793},{-14.3678,-41.3793},{-14.3678,9.77011},{-14.3862,9.77011}}));
