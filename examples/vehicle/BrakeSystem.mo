model BrakeSystem
  ...
  annotation(Diagram(), Icon(graphics = {Rectangle(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-60.4652,63.8759},{60.4651,-52.093}}),Text(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-46.5116,24.186},{43.7209,-12.093}}, textString = "Brake System"),Line(points = {{-44.3411,-15.5039},{8.06202,-15.5039},{8.06202,-33.4884},{43.7209,-33.4884},{44.3411,-33.1783},{51.7829,-26.0465},{51.7829,-26.0465},{52.4031,-26.3566}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25)}));
