model DrivingResistance
  ...
  Modelica.Blocks.Sources.Constant const(k = 1000 * 0.014) annotation(Placement(visible = true, transformation(origin = {-28.5271,2.7907}, extent = {{-12,-12},{12,12}}, rotation = 0)));
