model Controller_SeriesHybrid
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis_lowSOC(uLow = 0.2, uHigh = 0.78, pre_y_start = false) annotation(Placement(visible = true, transformation(origin = {-31.3825,47.7778}, extent = {{-7.45106,-7.45106},{7.45106,7.45106}}, rotation = 0)));
  ...
  Modelica.Blocks.Sources.Constant const_torqueDemand(k = 200) annotation(Placement(visible = true, transformation(origin = {-16.3501,3.81783}, extent = {{-8.19616,-8.19616},{8.19616,8.19616}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const_speedDemand(k = 300) annotation(Placement(visible = true, transformation(origin = {-16.6925,-22.8489}, extent = {{-7.45106,-7.45106},{7.45106,7.45106}}, rotation = 0)));
