model GasPedal
  ...
  Modelica.Blocks.Math.Gain MaximumTorquePlusMinimumTorque(k = 100000) annotation(Placement(visible = true, transformation(origin = {-27.5191,8.89847}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
  connect(u,MaximumTorquePlusMinimumTorque.u) annotation(Line(points = {{-78.7356,9.1954},{-57.4713,9.1954},{-57.4713,8.89847},{-41.9191,8.89847}}));
  connect(MaximumTorquePlusMinimumTorque.y,y) annotation(Line(points = {{-14.3191,8.89847},{72.4138,8.89847},{72.4138,5.17242},{80.4598,5.17242}}));
end GasPedal;
