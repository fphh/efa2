model Controller_Battery
  ...
  Modelica.Blocks.Math.Gain toSOC(k = 1 / (0.1 * 3600 * 1000)) annotation(Placement(visible = true, transformation(origin = {36.2791,12.4031}, extent = {{-12,-12},{12,12}}, rotation = 0)));
