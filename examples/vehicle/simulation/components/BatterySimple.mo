model Battery
  ...
  Modelica.Electrical.Analog.Basic.Resistor resistor1(R = 0.05) annotation(Placement(visible = true, transformation(origin = {-60.9009,9.72973}, extent = {{12,-12},{-12,12}}, rotation = -270)));
