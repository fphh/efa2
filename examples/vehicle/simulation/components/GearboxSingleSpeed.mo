model Gearbox
  ...
  Modelica.Mechanics.Rotational.Components.Inertia inertia1(J = 0) annotation(Placement(visible = true, transformation(origin = {-17.0543,4.03101}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  Modelica.Mechanics.Rotational.Components.Inertia inertia2(J = 0) annotation(Placement(visible = true, transformation(origin = {45.2713,3.41085}, extent = {{-12,-12},{12,12}}, rotation = 0)));
