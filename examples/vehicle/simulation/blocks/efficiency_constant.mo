...
equation
  connect(not1.y,switch1.u2) annotation(Line(points = {{17.8535,38.6111},{32.7778,38.6111},{32.7778,38.5057},{33.3011,38.5057}}));
  connect(greaterequal1.y,not1.u) annotation(Line(points = {{-16.6851,38.5057},{-6.11111,38.5057},{-6.11111,38.6111},{-4.95638,38.6111}}));
