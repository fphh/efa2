model VehicleElectricSingleSpeed
  ...
  ElectricMotorSchematic electricmotorschematic1 annotation(Placement(visible = true, transformation(origin = {-29.595,-7.78816}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  DriverGasOnly drivergasonly1 annotation(Placement(visible = true, transformation(origin = {-56.4022,-8.99228}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  BatterySimple batterysimple1 annotation(Placement(visible = true, transformation(origin = {-29.2683,57.622}, extent = {{-12,-12},{12,12}}, rotation = 0)));
...
equation
  connect(electricmotorschematic1.pin_n,ground2.p) annotation(Line(points = {{-26.6555,2.74207},{-26.9767,2.74207},{-26.9767,31.6279},{-10.5426,31.6279},{-10.5426,23.4729},{-10.5426,23.4729}}));
  connect(batterysimple1.pin_p,electricmotorschematic1.pin_p) annotation(Line(points = {{-36.3293,67.061},{-48.062,67.061},{-48.062,2.17054},{-35.6909,2.17054},{-35.6909,2.374}}));
  connect(batterysimple1.pin_n,ground1.p) annotation(Line(points = {{-25.6464,67.061},{-4.34109,67.061},{-4.34109,67.1938},{-4.96124,67.1938}}));
  ...
  connect(speedsensor1.v,drivergasonly1.realinput1) annotation(Line(points = {{20.9129,-39.9494},{-71.6279,-39.9494},{-71.6279,-12.1179},{-64.9232,-12.1179}}));
  ...
  connect(drivergasonly1.y,electricmotorschematic1.u) annotation(Line(points = {{-46.8022,-6.01554},{-40.4984,-6.01554},{-40.4984,-6.36007},{-40.3851,-6.36007}}));
  connect(timetable1.y,drivergasonly1.u) annotation(Line(points = {{-80.7026,-5.36837},{-73.1783,-5.36837},{-73.1783,-5.4946},{-65.5557,-5.4946}}));
  connect(electricmotorschematic1.flange_a,gearboxsinglespeed1.flange_a) annotation(Line(points = {{-18.6545,-6.40438},{-6.23053,-6.40438},{-6.23053,-6.82171},{-6.61081,-6.82171}}));
