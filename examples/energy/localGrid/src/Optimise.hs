...
noflip :: XIdx.Eta node -> XIdx.Power node
noflip = TIdx.liftInSection $ \(TIdx.Eta e) -> TIdx.Power e


myflip :: XIdx.Eta node -> XIdx.Power node
myflip = TIdx.liftInSection $ \(TIdx.Eta e) -> TIdx.Power $ TIdx.flip e
