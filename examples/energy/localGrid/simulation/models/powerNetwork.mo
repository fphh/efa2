model powerNetwork
  ...
  GHSimulation.Grid.Wind wind1(filename = "maps/power.txt", tablename = "wind", powerScale = 1.0) annotation(Placement(visible = true, transformation(origin = {-41.8032,-55.4645}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  GHSimulation.Grid.Solar solar1(filename = "maps/power.txt", tablename = "solar", powerScale = 1.0) annotation(Placement(visible = true, transformation(origin = {9.05416,72.1312}, extent = {{-12,-12},{12,12}}, rotation = 0)));
...
equation
  ...
  connect(transformer1.pin_n,industry1.pin_p) annotation(Line(points = {{14.6645,16.307},{30.7932,16.307},{30.7932,-18.3515},{54.6525,-18.3515},{54.6525,-18.6175}}));
