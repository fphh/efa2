model powerNetwork
  GHSimulation.Grid.Transformer transformer1(powerScale = 1.0, etaMax = 0.9, filename = "maps/eta.txt", tablename = "transformer") annotation(Placement(visible = true, transformation(origin = {5.4645,15.5737}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  GHSimulation.Grid.StoragePlant storageplant1(filename = "maps/eta.txt", tablename = "storage", powerScale = 1, etaMax = 0.6) annotation(Placement(visible = true, transformation(origin = {-39.8907,-7.65019}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  GHSimulation.Grid.Wind wind1(filenamePower = "maps/power.txt", tablenamePower = "wind", powerScalePower = 1.0, filenameEta = "maps/eta.txt", tablenameEta = "wind", powerScaleEta = 1.0, maxEta = 0.4) annotation(Placement(visible = true, transformation(origin = {-41.8032,-55.4645}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant const(k = 1) annotation(Placement(visible = true, transformation(origin = {-72.1311,80.6011}, extent = {{-5.08917,-5.08917},{5.08917,5.08917}}, rotation = 0)));
  GHSimulation.Grid.Industry industry1(filename = "maps/power.txt", tablename = "industry", powerScale = 1.0) annotation(Placement(visible = true, transformation(origin = {63.1525,-22.9508}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  GHSimulation.Grid.HouseHold household1(filename = "maps/power.txt", tablename = "house", powerScale = 1) annotation(Placement(visible = true, transformation(origin = {62.5306,33.0601}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  GHSimulation.Grid.Solar solar1(filenamePower = "maps/power.txt", tablenamePower = "solar", powerScalePower = 1.0, filenameEta = "maps/eta.txt", tablenameEta = "solar", powerScaleEta = 1.0, maxEta = 0.7) annotation(Placement(visible = true, transformation(origin = {9.05416,72.1312}, extent = {{-12,-12},{12,12}}, rotation = 0)));
