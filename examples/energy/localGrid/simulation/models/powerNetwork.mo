model powerNetwork
  ...
  GHSimulation.Grid.StoragePlant storageplant1(filename = "maps/eta.txt", tablename = "constOne", powerScale = 1, etaMax = 0.6) annotation(Placement(visible = true, transformation(origin = {-39.8907,-7.65019}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  GHSimulation.Grid.Wind wind1(filenamePower = "maps/power.txt", tablenamePower = "wind", powerScalePower = 1.0, filenameEta = "maps/eta.txt", tablenameEta = "constOne", powerScaleEta = 1.0, maxEta = 0.4) annotation(Placement(visible = true, transformation(origin = {-41.8032,-55.4645}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  GHSimulation.Grid.Solar solar1(filenamePower = "maps/power.txt", tablenamePower = "solar", powerScalePower = 1.0, filenameEta = "maps/eta.txt", tablenameEta = "constOne", powerScaleEta = 1.0, maxEta = 0.7) annotation(Placement(visible = true, transformation(origin = {9.05416,72.1312}, extent = {{-12,-12},{12,12}}, rotation = 0)));
