...
x0num :: XMap Sc
x0num = M.fromList [ (edgeIdx Idx.X rec0 sec 1 2, toScalar 0.7),
                     (edgeIdx Idx.X rec0 sec 1 3, toScalar 0.3) ]
...
x1num :: XMap Sc
x1num = M.fromList [ (edgeIdx Idx.X rec1 sec 1 2, toScalar 0.7),
                     (edgeIdx Idx.X rec1 sec 1 3, toScalar 0.3) ]
...
sigs0eq = M.fromList [ (edgeIdx Idx.Power rec0 sec 0 1, mkVar $ edgeIdx Idx.Power rec0 sec 0 1) ]
...
x0eq =
   M.fromList [
      (edgeIdx Idx.X rec0 sec 1 2, mkVar $ edgeIdx Idx.X rec0 sec 1 2),
      (edgeIdx Idx.X rec0 sec 1 3, mkVar $ edgeIdx Idx.X rec0 sec 1 3)
      ]
...
sigs1eq = M.fromList [ (edgeIdx Idx.Power rec1 sec 0 1, mkVar $ edgeIdx Idx.Power rec1 sec 0 1) ]
...
x1eq =
   M.fromList [
      (edgeIdx Idx.X rec1 sec 1 2, mkVar $ edgeIdx Idx.X rec1 sec 1 2),
      (edgeIdx Idx.X rec1 sec 1 3, mkVar $ edgeIdx Idx.X rec1 sec 1 3)
      ]
