...
t1 = "left event"
pa1 = [1,2,3,0,0,0]
pmap1 = M.fromList [(PPosIdx node0 node1, pa1)]

t2 = "right event"
pa2 = [0,0,0,4,4,4]
pmap2 = M.fromList [(PPosIdx node0 node1, pa2)]

t3 = "only one start point"
pa3 = [1,0,0,0,0,0]
pmap3 = M.fromList [(PPosIdx node0 node1, pa3)]

t4 = "only one end point"
pa4 = [0,0,0,0,0,1]
pmap4 = M.fromList [(PPosIdx node0 node1, pa4)]

t5 = "only one middle Point"
pa5 = [0,0,1,0,0,0]
pmap5 = M.fromList [(PPosIdx node0 node1, pa5)]

t6 = "two signals shifted to zero"
pa6 = [1,2,0,0,0,0]
pb6 = [3,4,3,0,0,0]
pmap6 = M.fromList [(PPosIdx node0 node1, pa6), (PPosIdx node1 node0, pb6)]

t7 = "two signals mixed event"
pa7 = [2,2,0,0,0,0]
pb7 = [0,0,3,3,3,3]
pmap7 = M.fromList [(PPosIdx node0 node1, pa7), (PPosIdx node1 node0, pb7)]

t8 = "zero crossing"
p8 = [2,2,2,-2,-2,-2]
pmap8 = M.fromList [(PPosIdx node0 node1, p8)]

t9 = "zero start Point"
p9 = [0,2,2,2,2,2]
pmap9 = M.fromList [(PPosIdx node0 node1, p9)]

t10 = "zero end Point"
p10 = [2,2,2,2,2,0]
pmap10 = M.fromList [(PPosIdx node0 node1, p10)]

t11 = "two events sametime"
p11a = [2,2,0,0,0,0]
p11b = [0,0,0,2,2,2]
pmap11 = M.fromList [(PPosIdx node0 node1, p11a), (PPosIdx node1 node0, p11b)]

t12 = "single Zero Point"
p12 = [2,2,0,2,2,2]
pmap12 = M.fromList [(PPosIdx node0 node1, p12)]
