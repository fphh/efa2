...
pmap1 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap2 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap3 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap4 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap5 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap6 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap7 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap8 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap9 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap10 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap11 :: Map (XIdx.PPos Node.Int) [Double]
...
pmap12 :: Map (XIdx.PPos Node.Int) [Double]
