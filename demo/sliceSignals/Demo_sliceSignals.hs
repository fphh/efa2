...
pmap1 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap2 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap3 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap4 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap5 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap6 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap7 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap8 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap9 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap10 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap11 :: M.Map (PPosIdx N.Nodes) [Double]
...
pmap12 :: M.Map (PPosIdx N.Nodes) [Double]
