...
class ToD3PlotData id key ndContainer inst dim label vec a b where
  toD3PlotData :: Caller -> id -> 
                  (Collection.Collection key ((ndContainer :: * -> * -> * -> (* -> *) -> * -> * -> *) inst dim label vec a b)) 
                  -> [PlotD3.PlotData key label a b]
