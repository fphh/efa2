...
toAbsEquation :: Assign -> Assign
toAbsEquation (GivenIdx x) = GivenIdx x
toAbsEquation (x ::= y) = x ::= toAbsEqTerm y

toAbsEquations :: [Assign] -> [Assign]
...
interpretEqTermFromScratch :: [Assign] -> Envs EqTerm
