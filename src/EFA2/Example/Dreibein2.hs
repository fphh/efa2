...
sigs0num = M.fromList [ (PowerIdx sec 0 0 1, toScalar 3.0),
                        (PowerIdx sec 0 1 2, toScalar 1.0) ]
...
sigs0eq =
   M.fromList [
      (PowerIdx sec 0 0 1, mkVar $ PowerIdx sec 0 0 1),
      (PowerIdx sec 0 1 2, mkVar $ PowerIdx sec 0 1 2)
      ]
...
sigs1eq =
   M.fromList [
      (PowerIdx sec 1 0 1, mkVar $ PowerIdx sec 1 0 1),
      (PowerIdx sec 1 1 2, mkVar $ PowerIdx sec 1 1 2)
      ]

dpower1eq :: DPowerMap EqTerm
dpower1eq =
   M.fromList [
      (DPowerIdx sec 1 0 1, mkVar $ DPowerIdx sec 1 0 1),
      (DPowerIdx sec 1 1 2, mkVar $ DPowerIdx sec 1 1 2)
      ]
