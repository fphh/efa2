...
sigs0num = M.fromList [ (Idx.Power sec rec0 0 1, toScalar 3.0),
                        (Idx.Power sec rec0 1 2, toScalar 1.0) ]
...
sigs0eq =
   M.fromList [
      (Idx.Power sec rec0 0 1, mkVar $ Idx.Power sec rec0 0 1),
      (Idx.Power sec rec0 1 2, mkVar $ Idx.Power sec rec0 1 2)
      ]
...
sigs1eq =
   M.fromList [
      (Idx.Power sec rec1 0 1, mkVar $ Idx.Power sec rec1 0 1),
      (Idx.Power sec rec1 1 2, mkVar $ Idx.Power sec rec1 1 2)
      ]

dpower1eq :: DPowerMap EqTerm
dpower1eq =
   M.fromList [
      (Idx.DPower sec rec1 0 1, mkVar $ Idx.DPower sec rec1 0 1),
      (Idx.DPower sec rec1 1 2, mkVar $ Idx.DPower sec rec1 1 2)
      ]
