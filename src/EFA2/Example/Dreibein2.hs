...
sigs0eq =
   M.fromList [
      (PowerIdx 0 0 0 1, mkVar $ PowerIdx 0 0 0 1),
      (PowerIdx 0 0 1 2, mkVar $ PowerIdx 0 0 1 2)
      ]
...
sigs1eq =
   M.fromList [
      (PowerIdx 0 1 0 1, mkVar $ PowerIdx 0 1 0 1),
      (PowerIdx 0 1 1 2, mkVar $ PowerIdx 0 1 1 2)
      ]

dpower1eq :: DPowerMap EqTerm
dpower1eq =
   M.fromList [
      (DPowerIdx 0 1 0 1, mkVar $ DPowerIdx 0 1 0 1),
      (DPowerIdx 0 1 1 2, mkVar $ DPowerIdx 0 1 1 2)
      ]
