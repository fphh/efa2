...
x0num :: XMap Sc
x0num = M.fromList [ (XIdx sec rec0 1 2, toScalar 0.7),
                     (XIdx sec rec0 1 3, toScalar 0.3) ]
...
x1num :: XMap Sc
x1num = M.fromList [ (XIdx sec rec1 1 2, toScalar 0.7),
                     (XIdx sec rec1 1 3, toScalar 0.3) ]
...
sigs0eq = M.fromList [ (PowerIdx sec rec0 0 1, mkVar $ PowerIdx sec rec0 0 1) ]
...
x0eq =
   M.fromList [
      (XIdx sec rec0 1 2, mkVar $ XIdx sec rec0 1 2),
      (XIdx sec rec0 1 3, mkVar $ XIdx sec rec0 1 3)
      ]
...
sigs1eq = M.fromList [ (PowerIdx sec rec1 0 1, mkVar $ PowerIdx sec rec1 0 1) ]
...
x1eq =
   M.fromList [
      (XIdx sec rec1 1 2, mkVar $ XIdx sec rec1 1 2),
      (XIdx sec rec1 1 3, mkVar $ XIdx sec rec1 1 3)
      ]
