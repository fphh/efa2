...
dx1num :: DXMap Sc
dx1num = M.fromList [ (DXIdx sec rec1 0 1, toScalar 0.0),
                      (DXIdx sec rec1 1 0, toScalar 0.0),
...
power0eq = M.fromList [ (PowerIdx sec rec0 0 1, mkVar $ PowerIdx sec rec0 0 1) ]


{-
-- backwards
power0eq :: PowerMap EqTerm
power0eq = M.fromList [ (PowerIdx sec rec0 2 1, mkVar $ PowerIdx sec rec0 2 1) ]
-}


eta0eq :: FEtaMap EqTerm
eta0eq = M.fromList [ (FEtaIdx sec rec0 1 0, const $ mkVar $ FEtaIdx sec rec0 1 0),
...
power1eq = M.fromList [ (PowerIdx sec rec1 0 1, mkVar $ PowerIdx sec rec1 0 1) ]

dpower1eq :: DPowerMap EqTerm
dpower1eq = M.fromList [ (DPowerIdx sec rec1 0 1, mkVar $ DPowerIdx sec rec1 0 1) ]

{-
-- backward
power1eq :: PowerMap EqTerm
power1eq = M.fromList [ (PowerIdx sec rec1 2 1, Power (PowerIdx sec rec1 2 1)) ]

dpower1eq :: DPowerMap EqTerm
dpower1eq = M.fromList [ (DPowerIdx sec rec1 2 1, DPower (DPowerIdx sec rec1 2 1)) ]
-}

eta1eq :: FEtaMap EqTerm
eta1eq = M.fromList [ (FEtaIdx sec rec1 1 0, const $ mkVar $ FEtaIdx sec rec1 1 0),
...
dx1eq :: DXMap EqTerm
dx1eq = M.fromList [ (DXIdx sec rec1 0 1, Const 0.0),
                     (DXIdx sec rec1 1 0, Const 0.0),
                     (DXIdx sec rec1 1 2, Const 0.0),
                     (DXIdx sec rec1 2 1, Const 0.0) ]

deta1eq :: DEtaMap EqTerm
deta1eq = M.fromList [ (DEtaIdx sec rec1 1 0, const $ mkVar $ DEtaIdx sec rec1 1 0),
