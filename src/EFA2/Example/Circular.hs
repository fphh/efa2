...
sigs (PowerIdx 1 2) = return [3.2]
sigs (PowerIdx 2 1) = return [2.0]
sigs (PowerIdx 2 3) = return [0.8]
sigs (PowerIdx 3 2) = return [0.2]

sigs (PowerIdx 1 4) = return [1.0]
sigs (PowerIdx 4 1) = return [2.4]
sigs (PowerIdx 4 5) = return [1.8]
sigs (PowerIdx 5 4) = return [2.0]

sigs (PowerIdx 2 4) = return [1.2]
sigs (PowerIdx 4 2) = return [0.6]
