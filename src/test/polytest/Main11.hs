...
instance Vector Signal a where
  toVector (Signal x) = x
  fromVector x = Signal x
  
instance Vector Hist a where  
  toVector (Hist x) = x
  fromVector x = Hist x
...
instance (SigProd a b c) => Prod (Signal a) (Signal b) (Signal c)
instance (HSigProd a b c) => Prod (Hist a) (Signal b) (Signal c)
