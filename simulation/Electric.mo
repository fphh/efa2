package Electric
  ...
  equation
    connect(constantvoltage1.n,pin_n) annotation(Line(points = {{-68.3333,30.8889},{-68.0556,30.8889},{-68.0556,-32.1936},{63.0556,-32.1936},{63.0556,-32.2222}}));
  ...
  model powerSourceSupply
    ...
    Real _powerSupply_log;
    Real _voltage_log;
    Real _current_log;
    Real _powerElectric_log;
  equation
