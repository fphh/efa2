package Electric
  ...
  model powerSourceSupply
    ...
    powerOutEfficiency poweroutefficiency1(powerScale = powerScale, maxEta = maxEta, filename = filename, tablename = tablename) annotation(Placement(visible = true, transformation(origin = {-21.6667,65}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  equation
  ...
  model powerSourceDemand
    ...
    Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(visible = true, transformation(origin = {87.9605,32.4707}, extent = {{-12,-12},{12,12}}, rotation = 0), iconTransformation(origin = {87.9605,32.4707}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    Modelica.Electrical.Analog.Sensors.PowerSensor powersensor1 annotation(Placement(visible = true, transformation(origin = {26.9444,32.2222}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    powerOutEfficiency poweroutefficiency1(powerScale = powerScale, maxEta = maxEta, filename = filename, tablename = tablename) annotation(Placement(visible = true, transformation(origin = {-21.9777,65}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  equation
    connect(poweroutefficiency1.powerIn,coalPower) annotation(Line(points = {{-13.6111,67.3},{64.4444,67.3},{64.4444,60.8333},{73.3333,60.8333}}));
    connect(powersensor1.power,poweroutefficiency1.powerOut) annotation(Line(points = {{17.3444,19.0222},{17.3444,13.0556},{-69.4444,13.0556},{-69.4444,66.9444},{-31.3444,66.9444},{-31.3444,66.4333}}));
    connect(PowerDemand,signalcurrent1.i) annotation(Line(points = {{-80.3143,1.03801},{-46.0342,1.03801},{-46.0342,0.833333},{-45.9,0.833333}}));
    connect(powersensor1.nv,pin_n) annotation(Line(points = {{26.9444,20.2222},{85.8333,20.2222},{85.8333,-20.9649},{85.0877,-20.9649}}));
    connect(powersensor1.pv,pin_p) annotation(Line(points = {{26.9444,44.2222},{87.2222,44.2222},{87.2222,32.4707},{87.9605,32.4707}}));
    connect(powersensor1.pc,signalcurrent1.n) annotation(Line(points = {{14.9444,32.2222},{-37.7778,32.2222},{-37.7778,12.8333},{-37.5,12.8333}}));
  ...
  model ElectricEfficiency
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combitable1ds1(tableOnFile = true, tableName = tablename, fileName = filename) annotation(Placement(visible = true, transformation(origin = {-14.3533,56.3797}, extent = {{-7.45106,-7.45106},{7.45106,7.45106}}, rotation = 0)));
