...
package Electric
  block powerOutEfficiency
    Modelica.Blocks.Interfaces.RealInput u annotation(Placement(visible = true, transformation(origin = {-78.0556,11.9444}, extent = {{-12,-12},{12,12}}, rotation = 0), iconTransformation(origin = {-78.0556,11.9444}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    ...
    Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(visible = true, transformation(origin = {69.7222,19.1667}, extent = {{-12,-12},{12,12}}, rotation = 0), iconTransformation(origin = {69.7222,19.1667}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    Modelica.Blocks.Tables.CombiTable1Ds combitable1ds1 annotation(Placement(visible = true, transformation(origin = {-42.2222,11.6667}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  equation
    ...
    connect(division1.y,y) annotation(Line(points = {{54.5889,53.8889},{60.8333,53.8889},{60.8333,19.1667},{69.7222,19.1667}}));
    connect(division1.u1,u) annotation(Line(points = {{26.9889,61.0889},{-71.3889,61.0889},{-71.3889,11.9444},{-78.0556,11.9444}}));
    ...
    connect(u,combitable1ds1.u) annotation(Line(points = {{-78.0556,11.9444},{-43.6111,11.9444},{-43.6111,11.6667},{-56.6222,11.6667}}));
  ...
  model ElectricEfficiency
    ...
    Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(visible = true, transformation(origin = {36.1111,13.0556}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    ...
    Modelica.Blocks.Tables.CombiTable1Ds combitable1ds1 annotation(Placement(visible = true, transformation(origin = {-42.2222,55.8333}, extent = {{-12,-12},{12,12}}, rotation = 0)));
    Modelica.Blocks.Routing.Extractor extractor1 annotation(Placement(visible = true, transformation(origin = {-2.5,55.5556}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  equation
    connect(integerconstant1.y,extractor1.index) annotation(Line(points = {{-10.6927,26.3889},{-2.77778,26.3889},{-2.77778,41.1556},{-2.5,41.1556}}));
    connect(extractor1.y,variableresistor1.R) annotation(Line(points = {{10.7,55.5556},{36.3889,55.5556},{36.3889,26.2556},{36.1111,26.2556}}));
    connect(combitable1ds1.y,extractor1.u) annotation(Line(points = {{-29.0222,55.8333},{-18.3333,55.8333},{-18.3333,55.5556},{-16.9,55.5556}}));
    connect(powersensor1.power,combitable1ds1.u) annotation(Line(points = {{-52.9333,0.133333},{-52.9333,-14.4444},{-65.5556,-14.4444},{-65.5556,56.1111},{-56.6222,56.1111},{-56.6222,55.8333}}));
    ...
    connect(variableresistor1.n,pin_n) annotation(Line(points = {{48.1111,13.0556},{80.5556,13.0556},{80.5556,12.2222},{81.3889,12.2222}}));
    connect(powersensor1.nc,variableresistor1.p) annotation(Line(points = {{-31.3333,13.3333},{23.6111,13.3333},{23.6111,13.0556},{24.1111,13.0556}}));
  ...
  equation
    connect(powersensor1.power,poweroutefficiency1.u) annotation(Line(points = {{17.3444,19.0222},{17.3444,13.0556},{-69.4444,13.0556},{-69.4444,66.9444},{-31.0333,66.9444},{-31.0333,66.4333}}));
    connect(poweroutefficiency1.y,coalPower) annotation(Line(points = {{-13.3,67.3},{64.4444,67.3},{64.4444,60.8333},{73.3333,60.8333}}));
    ...
    connect(PowerDemand,signalcurrent1.i) annotation(Line(points = {{-80.3143,1.03801},{-46.6667,1.03801},{-46.6667,0.833333},{-45.9,0.833333}}));
  end powerSource;
  model PowerSink
